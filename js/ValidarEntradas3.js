...
function Gestionar(emailsel,nu_tipo_entidad_sta,in_clasificacion_tipo_ent_sta){
  document.forms.reporte.emailsel.value=emailsel;
  document.forms.reporte.nu_tipo_entidad_sta.value=nu_tipo_entidad_sta;
  document.forms.reporte.in_clasificacion_tipo_ent_sta.value=in_clasificacion_tipo_ent_sta;
  document.forms.reporte.accion.value="Gestionar";
  document.forms.reporte.submit();
}  
