...
if ($accion=="Gestionar"){
	...
	gestionar_usuario($accion,$emailsel,$nu_tipo_entidad_sta,$in_clasificacion_tipo_ent_sta);
		...
		$reporteUserconf=show_reporteUsers($OrderBy);
...
?>					
			<tr  class="Report-row-header">
				<td width="200px" onClick="Ordenar('nombre');" class="title-report">NOMBRE
				</td>	
				<td width="250px" onClick="Ordenar('emailuser');" class="title-report">EMAIL
				</td>	
				<td width="200px">ACCION
				</td>	
			</tr>
<?php 	
...
?>		
			<tr  class="Report-row-<?php echo $class;?>">
				<td width="200px"><?php echo $row_rsdepto['nombre'];?>
				</td>	
				<td width="250px"><?php echo $row_rsdepto['emailuser']?>
				</td>	
				<td width="200px">
				<button type="button" onClick="Gestionar('<?php echo $row_rsdepto['emailuser']?>',1,'ACT')" class="btnOksmall">Aceptar</button>
				<button type="button" onClick="Gestionar('<?php echo $row_rsdepto['emailuser']?>',4,'RCH')" class="btnNotsmall">Rechazar</button>	
				</td>	
			</tr>
